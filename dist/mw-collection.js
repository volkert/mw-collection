  ...
  angular.module('mwCollection', []).run([
    ...
    function (MwModel) {
      return Backbone.Collection.extend({
        ...
        initialize: function () {
          ...
          this.__initialFilterValues = angular.copy(this.filterValues);  // TODO: load persisted filters into this.filterValues and sortOrder here
                                                                         // ....
        },
        getFilters: function () {
      ...
      return Backbone.Model.extend({
        ...
        parse: function (response) {
          ...
          if (response.data && response.data.results) {
            return response.data.results[0];  // If Model is embedded in collection, it's already parsed correctly
          } else {
            return response;
          }
        },
    ...
    return {
      ...
      logOp: function (filters, operator) {
        filters = _.without(filters, null);
        // Removing null values from existing filters
